...
tip (npr. \verb|bool| v C++), kjer bi vrednost \verb|true| predstavljala zasedenost, \verb|false| pa dosegljivost.
...
\subsection{Merjenje kakovosti urnika}
...
\subsection{Grafični uporabniški vmesnik}
